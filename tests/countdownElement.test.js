// tests/countdownElement.test.js
...
function formatCountdownMs(ms, format) {
...
function computeRemainingMs(durationMs, elapsedMs, endBehaviour) {
...
// ── Property-based tests (manual random sampling) ────────────────────────────
