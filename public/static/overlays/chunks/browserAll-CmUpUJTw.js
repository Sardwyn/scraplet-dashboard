var _a;
import { l as Ticker, U as UPDATE_PRIORITY, m as Point, o as removeItems, p as ExtensionType, E as EventEmitter, w as warn, q as extensions, s as Container } from "./LeaferGraphicCore-CrHLFAJB.js";
import "./webworkerAll-DxIJXiq6.js";
import "./canvasUtils-E6HZ9Wyo.js";
import "./CanvasPool-Bw3MWSzT.js";
...
class EventBoundary {
  ...
  notifyTarget(e, type) {
    ...
    (_b = (_a2 = e.currentTarget)[handlerKey]) == null ? void 0 : _b.call(_a2, e);
  ...
  mapPointerOver(from) {
    ...
    if (e.pointerType === "mouse") this.cursor = (_a2 = e.target) == null ? void 0 : _a2.cursor;
    const enterEvent = this.clonePointerEvent(e, "pointerenter");
    enterEvent.eventPhase = enterEvent.AT_TARGET;
  ...
  _normalizeToPointerData(event) {
    ...
    if (this.supportsTouchEvents && event instanceof TouchEvent) {
      for (let i = 0, li = event.changedTouches.length; i < li; i++) {
        ...
        (_a2 = touch.altKey) != null ? _a2 : touch.altKey = event.altKey;
        (_b = touch.ctrlKey) != null ? _b : touch.ctrlKey = event.ctrlKey;
        (_c = touch.metaKey) != null ? _c : touch.metaKey = event.metaKey;
        (_d = touch.shiftKey) != null ? _d : touch.shiftKey = event.shiftKey;
...
//# sourceMappingURL=browserAll-CmUpUJTw.js.map
